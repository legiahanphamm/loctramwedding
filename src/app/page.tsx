    ...
    <main className="bg-[#3a2c22] text-white min-h-screen relative overflow-hidden">
      ...
      <section className="relative min-h-[72vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-6 pt-14 sm:pt-16">
          <p className="font-serif tracking-[0.35em] sm:tracking-[0.6em] text-xs sm:text-sm mb-10 sm:mb-20">
            THE WEDDING OF
          </p>

          <h1 className="text-[clamp(44px,12vw,120px)] leading-[0.9] font-script mb-10 sm:mb-20 flex items-end justify-center gap-[0.2em] md:gap-[0.5em]">
            <span className="inline-flex items-end mr-[0.35em] sm:mr-[0.45em] md:mr-[1em]">
      ...
      {/* ENVELOPE SECTION */}
      <section className="bg-[#3a2c22] text-white pb-16 sm:pb-24 px-4 sm:px-0">
        <div className="mx-auto flex w-full max-w-6xl flex-col items-center px-0 sm:px-4">
          <div className="relative w-full max-w-300 aspect-1200/850 overflow-hidden rounded-[28px] border border-white/8 shadow-[0_24px_80px_rgba(0,0,0,0.2)]">
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-between px-4 py-5 sm:px-8 sm:py-9 md:px-10 md:py-10">
              <div className="mt-[5%] sm:mt-[13%] md:mt-[16%] text-center text-black">
                <h1 className="text-[clamp(40px,10vw,80px)] leading-[0.92] font-script whitespace-nowrap">
                  Kindly Respond
                </h1>
              </div>

              <div className="mb-[7%] w-full max-w-[96%] sm:max-w-[80%] rounded-[20px] bg-white/10 px-4 py-3 text-center text-black backdrop-blur-[2px] sm:px-6 sm:py-4">
                ...
                <p className="mt-5 sm:mt-5 font-serif italic text-[clamp(10px,1.5vw,22px)] leading-5 sm:leading-7 tracking-[0.06em] sm:tracking-widest">
                  PLEASE RESPOND BEFORE 9PM (MAY 5TH, 2026)
                </p>
                <p className="font-serif italic text-[clamp(10px,1.5vw,22px)] leading-5 sm:leading-7 tracking-[0.06em] sm:tracking-widest">
            ...
            <Image
              ...
              width={120}
              height={120}
              className="absolute right-10 bottom-10 w-11 h-11 sm:right-5 sm:bottom-5 sm:w-18 sm:h-18 md:w-24 md:h-24 lg:w-28 lg:h-28"
            />
          </div>
        </div>
      </section>
      ...
      <section className="bg-[#f4f2ec] text-[#19140f] mt-20 sm:mt-24 py-24 sm:py-35 px-4 sm:px-8 md:px-10">
        <div className="text-center mx-auto max-w-6xl">
          <h1 className="text-[clamp(40px,8vw,96px)] leading-[0.92] font-script mb-18 sm:mb-30 flex flex-col sm:flex-row items-center justify-center gap-0 sm:gap-[1em]">
            <span>Wedding</span>
            <span className="-mt-1 sm:mt-0">Timeline</span>
          </h1>
      ...
      <section className="bg-[#3a2c22] text-white py-24 sm:py-35 px-4 sm:px-8 md:px-10">
        <div className="text-center mx-auto max-w-6xl">
          <h1 className="text-[clamp(40px,8vw,96px)] leading-[0.92] font-script mb-18 sm:mb-30 flex flex-col sm:flex-row items-center justify-center gap-2 sm:gap-[1.5em]">
            <span>Wedding</span>
            <span className="-mt-1 sm:mt-0">Venue</span>
          </h1>
          ...
          <div className="mt-10 sm:mt-12 grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-10 items-center">
            <div className="text-center lg:text-left">
              <p className="font-serif tracking-[0.08em] leading-7 text-[clamp(12px,1.5vw,16px)] uppercase">
              ...
              <p className="font-serif italic mt-6 sm:mt-8 tracking-[0.06em] leading-7 text-[clamp(12px,1.5vw,16px)] uppercase">
